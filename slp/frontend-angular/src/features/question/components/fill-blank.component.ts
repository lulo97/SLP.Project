...
@Component({
  ...
  template: `
    <nz-form-item>
      ...
      <nz-form-control>
        <input nz-input [(ngModel)]="keyword" (ngModelChange)="onKeywordChange()" placeholder="Enter the correct keyword" />
      </nz-form-control>
    </nz-form-item>
    ...
    <nz-form-item>
      ...
      <nz-form-control>
        <div class="preview-container">
          <div *ngIf="!questionTitle" class="text-gray-400 italic p-3 bg-gray-50 rounded border">
            Enter question title first
          </div>
          <div *ngIf="questionTitle && !keyword" class="text-gray-400 italic p-3 bg-gray-50 rounded border">
            Enter a keyword to see preview
          </div>
          <div *ngIf="questionTitle && keyword" class="preview-content p-3 bg-gray-50 rounded border">
            <ng-container *ngFor="let part of previewParts">
              <span *ngIf="part.isBlank" class="blank-placeholder px-3 py-0.5 bg-yellow-100 border border-yellow-300 rounded mx-0.5 font-mono">_____</span>
