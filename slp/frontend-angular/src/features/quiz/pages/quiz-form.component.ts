        ...
        <nz-form-item>
          ...
          <nz-form-control>
            <input
              ...
              [placeholder]="'quiz.titlePlaceholder' | translate"
        ...
        <nz-form-item>
          ...
          <nz-form-control>
            <textarea
              ...
              rows="3"
              [placeholder]="'quiz.descriptionPlaceholder' | translate"
        ...
        <nz-form-item>
          ...
          <nz-form-control>
            <nz-radio-group
              ...
              data-testid="quiz-visibility-radio-group"
            >
              <label
                nz-radio
                nzValue="private"
                data-testid="quiz-visibility-private"
                >{{ "quiz.visibilityPrivate" | translate }}</label
              >
              <label
                nz-radio
                nzValue="public"
                data-testid="quiz-visibility-public"
                >{{ "quiz.visibilityPublic" | translate }}</label
              >
            </nz-radio-group>
          </nz-form-control>
        </nz-form-item>
  ...
  onSubmit(): void {
    ...
    if (this.isEdit && this.quizId) {
      this.quizService.updateQuiz(this.quizId, payload).subscribe({
        ...
        error: () =>
          this.message.error(this.translate.instant("quiz.updateError")),
      });
    } else {
      this.quizService.createQuiz(payload).subscribe({
        ...
        error: () =>
          this.message.error(this.translate.instant("quiz.createError")),
      });
    }
  }
}
