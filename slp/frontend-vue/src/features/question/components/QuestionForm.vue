<template>
  <a-form :model="form" @submit.prevent="handleSubmit" layout="vertical">
    ...
    <a-form-item
      label="Question Type"
      required
      data-testid="form-item-question-type"
    >
      <a-select
      ...
      >
        ...
        <a-select-option value="true_false" data-testid="option-true-false">
          True/False
        </a-select-option>
        <a-select-option value="fill_blank" data-testid="option-fill-blank">
          Fill Blank
        </a-select-option>
        <a-select-option value="ordering" data-testid="option-ordering">
          Ordering
        </a-select-option>
        <a-select-option value="matching" data-testid="option-matching">
          Matching
        </a-select-option>
      </a-select>
    </a-form-item>
...
const initializeForm = () => {
  ...
  switch (q.type) {
    ...
    case "matching": {
      ...
      form.value.matchingPairs = pairs.length
        ? pairs
        : [
            { left: "", right: "" },
            { left: "", right: "" },
...
function buildMetadata(): Record<string, any> {
  ...
  switch (form.value.type) {
    case "multiple_choice": {
      ...
      const correctTexts = form.value.correctAnswers.filter(
        (ans) => ans.trim() !== "",
      );
