<template>
  <div
    class="fixed top-0 right-0 h-screen w-[320px] bg-[#faf9f6] border-l border-[#e8e4dc] shadow-[-4px_0_24px_rgba(0,0,0,0.06)] z-[200] flex flex-col transition-transform duration-[280ms] ease-[cubic-bezier(0.4,0,0.2,1)]"
