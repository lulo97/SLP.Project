<template>
  ...
  >
    <ol class="flex items-center min-w-0">
      ...
      >
        ...
        <span v-if="item.ellipsis" class="text-gray-400 text-xs px-1 shrink-0">
          …
        </span>
  ...
  <h1 v-else class="text-xl font-semibold truncate">
    {{ fallbackTitle }}
  </h1>
</template>
...
const QUESTION_LIST: BreadcrumbItem = { label: 'Question Bank', path: '/questions' };
